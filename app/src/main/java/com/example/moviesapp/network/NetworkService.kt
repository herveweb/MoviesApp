...
class NetworkService {
    ...
    suspend fun getMovies(page: Int): ApiMovieListResult = withContext(Dispatchers.Default) {
        moviesService.getMovies(page)
    }

    suspend fun getMovieDetails(movieId: Int): Movie = withContext(Dispatchers.Default) {
...
interface MoviesService {
    ...
    suspend fun getMovies(@Query("page") page: Int): ApiMovieListResult
